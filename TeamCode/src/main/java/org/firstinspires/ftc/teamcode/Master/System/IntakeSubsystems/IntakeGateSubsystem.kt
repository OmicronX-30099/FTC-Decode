package org.firstinspires.ftc.teamcode.Master.System.IntakeSubsystems
...
object IntakeGateSubsystem: Subsystem {
    ...
    val leftIntakeGateServo: ServoEx = ServoEx("il_gate")
    val rightIntakeGateServo: ServoEx = ServoEx("ir_gate")
